...
Связь со мной: через сообщения группы <a href="{{ site.contact_vk }}">ВКонтакте</a> или в <a href="{{ site.contact_telegram }}">Telegram</a>, а также по электронной почте <a href="mailto:{{ site.email }}">{{ site.email }}</a>
